...
namespace MultiTenant.Catalog.Infrastructure.Migrations.MySql
{
        ...
        : IDesignTimeDbContextFactory<MySqlCatalogContext>
    {
        public MySqlCatalogContext CreateDbContext(string[] args)
        {
            ...
            builder.UseMySql(serverVersion: ServerVersion.AutoDetect("Server=192.168.1.60;Port=3306;Database=tenant-catalog;Uid=root;Pwd=secret;"),
                connectionString: "Server=192.168.1.60;Port=3306;Database=tenant-catalog;Uid=root;Pwd=secret;", mySqlOptionsAction: config =>
